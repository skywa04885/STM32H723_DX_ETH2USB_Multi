...
#ifndef INC_DX_ETH2USB_ACTIVE_SERVO_CLASS_STATES_IDLE_H_
#define INC_DX_ETH2USB_ACTIVE_SERVO_CLASS_STATES_IDLE_H_
...
#endif /* INC_DX_ETH2USB_ACTIVE_SERVO_CLASS_STATES_IDLE_H_ */
